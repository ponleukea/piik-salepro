  ...
  Future<List<int>> getTicket(
    ...
    List.generate(productList?.length ?? 1, (index) {
      return bytes += generator.row([
        ...
        PosColumn(
            text:
                '${TypesHelper.roundNum(double.parse(productList?[index].subTotal))}' ??
                    'Not Defined',
            width: 3,
            styles: const PosStyles(
              align: PosAlign.center,
        ...
        PosColumn(
            text:
                "${TypesHelper.roundNum(double.parse(productList?[index].subTotal) * productList![index].quantity.toInt())}",
            width: 3,
    ...
    bytes += generator.row([
      ...
      PosColumn(
          text:
              '\$${TypesHelper.roundNum(printTransactionModel.transitionModel!.totalAmount!.toDouble() + printTransactionModel.transitionModel!.discountAmount!.toDouble())}',
          width: 4,
          styles: const PosStyles(
    ...
    bytes += generator.row([
      ...
      PosColumn(
          text:
              '\$${TypesHelper.roundNum(printTransactionModel.transitionModel!.discountAmount!)}' ??
                  '',
          width: 4,
          styles: const PosStyles(
            align: PosAlign.right,
    ...
    bytes += generator.row([
      ...
      PosColumn(
          text:
              '\$${TypesHelper.roundNum(printTransactionModel.transitionModel!.totalAmount!)}' ??
                  '',
          width: 4,
          styles: const PosStyles(align: PosAlign.right, bold: true)),
    ]);
    ...
    bytes += generator.row([
      ...
      PosColumn(
          text:
              '\$${TypesHelper.roundNum(printTransactionModel.transitionModel!.totalAmount!.toDouble() - printTransactionModel.transitionModel!.dueAmount!.toDouble())}',
          width: 4,
          styles: const PosStyles(
            align: PosAlign.right,
          )),
    ...
    bytes += generator.row([
      ...
      PosColumn(
          text:
              '\$${TypesHelper.roundNum(printTransactionModel.transitionModel!.returnAmount!)}',
          width: 4,
          styles: const PosStyles(
            align: PosAlign.right,
          )),
    ...
    bytes += generator.row([
      ...
      PosColumn(
          text:
              '\$${TypesHelper.roundNum(printTransactionModel.transitionModel!.dueAmount!)}',
          width: 4,
          styles: const PosStyles(
            align: PosAlign.right,
          )),
    ...
    bytes += generator.text(
        printTransactionModel.transitionModel!.purchaseDate.substring(0, 19),
        styles: const PosStyles(align: PosAlign.center));
